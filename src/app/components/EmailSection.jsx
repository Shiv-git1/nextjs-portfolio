...
const EmailSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setError(true);
    alert("Oops, this didn't work try connecting me on Linkdein!");
    ...
    >
      ...
      <div className="z-10">
        ...
        <div className="socials flex flex-row gap-2">
          <Link href="https://github.com/Shiv-git1">
            <Image
              src={GithubIcon}
          ...
          <Link href="https://www.linkedin.com/in/shiv-shakti-bharti-aab505104">
            <Image
              src={LinkedinIcon}
              style={{ background: "white", borderRadius: "4px" }}
              alt="Linkedin-icon"
        ...
        <form className="flex flex-col" onSubmit={handleSubmit}>
          ...
          {error && (
            <>
              ...
              <p className="text-red-500 text-sm mt-2">Please try Linkedin</p>
            </>
          )}
        </form>
      </div>
