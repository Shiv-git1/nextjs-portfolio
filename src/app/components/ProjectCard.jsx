    ...
    <div>
      ...
      >
        ...
        >
          ...
          >
            <CodeBracketIcon
              className="h-10 w-10 text-[#ADB7BE] absolute top-1/2 left-1/2 transform
      ...
      <div className="text-white rounded-b-xl mt-2 bg-[#181818] p-6 px-4">
        <h5 className="text-xl font-semibold mb-2">{title}</h5>
        <p className="text-[#ADB7BE]">{description}</p>
        <p className="mt-2">
          Tools Used:{" "}
          <span className="text-primary-500">{skills?.join(", ")}</span>
        </p>
      </div>
    </div>
  );
